...
class Spaghetti:
    ...
    def clone(self):
        cloned_spaghetti = Spaghetti(self.name)
        cloned_spaghetti.dough = self.dough
        cloned_spaghetti.protein = self.protein
        cloned_spaghetti.sauce = self.sauce
        cloned_spaghetti.vegetables = self.vegetables
        cloned_spaghetti.toppings = self.toppings
        cloned_spaghetti.decor = self.decor
        cloned_spaghetti.cooking_time = self.cooking_time
        return cloned_spaghetti
